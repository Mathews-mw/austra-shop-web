...
export function DiscountedProductsSection() {
	return (
		<div className="flex flex-col items-center gap-8 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
			{discountedProducts.map((product) => {
				return (
					<div key={product.id} className="relative flex flex-col gap-4">
